const ProjectsData = [
  {
    ...
    title: "Todo App 🗒️",
    description:
      "A Simple Todo App built using React, Sass and TypeScript. The Application UI is based on MacOS, while it uses your browsers local storage to store your Todos. This is my first work with typescript so as to bring the type safety and better developer experience into the picture.",
    stack: ["ReactJs", "TypeScript", "Sass"],
    code: "https://github.com/AmandeepMewar/Todo-App-TS",
    demo: "https://wttodoappts.netlify.app/",
  },
  {
    id: 1,
    title: "PostInks Notes App 📝",
    description:
      "A Full-Stack CRUD Application created using the tech stack React.js and Tailwind CSS for front-end while Node.js and Express.js for the backend and NoSQL database MongoDB. In the application user can create new posts, edit them and delete them if required.",
    stack: [
      "ReactJs",
      "JavaScript",
      "TailwindCSS",
    ...
    code: "https://github.com/AmandeepMewar/PostInks-Notes-App",
    demo: "https://postinksx-crud.netlify.app/",
  },
  {
    id: 2,
    title: "RedXone E-commerce Game Store 🎮",
    description:
